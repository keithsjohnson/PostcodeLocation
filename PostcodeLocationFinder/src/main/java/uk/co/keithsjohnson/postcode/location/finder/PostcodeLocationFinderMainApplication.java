package uk.co.keithsjohnson.postcode.location.finder;
...
public class PostcodeLocationFinderMainApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(PostcodeLocationFinderMainApplication.class, args);
	}
